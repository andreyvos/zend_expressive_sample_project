...
class ConfigProvider
{
    ...
    public function getRoutes(): array
    {
        return [
            ...
            [
                'name' => 'student/user/view/resultset_ajax',
                'path' => '/student/user/resultset_ajax',
                'middleware' => 'Student\User\Action\View\ResultSet\ByUserRoleAjax',
                'allowed_methods' => ['GET']
            ],
            [
    ...
    public function getDependencies(): array
    {
        return [
            'factories' => [
                ...
                'Student\User\Action\View\ResultSet\ByUserRoleAjax' => User\Factory\Action\View\ResultSet\ByUserRoleAjax::class
            ]
        ];
    }
        ...
        return [
            'permissions' => [
                Role\Administrator::class => [
                    ...
                    'student/user/view/resultset_ajax',
                    'student/logs'
                ],
                Role\Tutor::class => [
                    'student/user/view/resultset',
