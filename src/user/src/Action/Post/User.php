                ...
                if ($oldTutorRow && $oldTutorRow->getTutorId()) {
                    ...
                    if (count($assignments) > 0) {
                        foreach ($assignments as $assignment) {
                            $assignmentObj = $this->assignmentWorkTable
                                ->buildAssignmentWork($this->assignmentWorkTable->fetchById($assignment['id']));
                            if (!empty($assignmentObj) && $assignmentObj[0]->isWaitingToPass()) {
