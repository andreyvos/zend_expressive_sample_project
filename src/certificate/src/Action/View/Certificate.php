...
class Certificate
{
    ...
    public function __construct(Template\TemplateRendererInterface $template, Attempt\Model\AttemptTable $attemptTable,
                                UserMetaTable $usermetaTable, ExamTable $examTable, CourseTable $courseTable,
                                TopicTable $topicTable, ContentTable $contentTable, OptionsTable $optionsTable)
    {
    ...
    public function __invoke(ServerRequestInterface $request, DelegateInterface $delegate)
    {
        ...
        $backgroundData = $this->optionsTable->fetchByName('certificate_background');
        $certBackground = !empty($backgroundData['value']) ? $backgroundData['value'] : null;
