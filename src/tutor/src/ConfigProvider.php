...
class ConfigProvider
{
    ...
    public function getRoutes(): array
    {
        return [
            ...
            [
                'name' => 'tutor/user/view/resultset_ajax',
                'path' => '/tutor/user/resultset_ajax',
                'middleware' => 'Tutor\User\Action\View\ResultSetAjax',
                'allowed_methods' => ['GET']
            ],
            [
    ...
    public function getDependencies(): array
    {
        return [
            'factories' => [
                ...
                'Tutor\User\Action\View\ResultSetAjax' => User\Factory\Action\View\ResultSetAjax::class,
        ...
        return [
            'permissions' => [
                Role\Administrator::class => [
                    ...
                    'tutor/user/view/resultset_ajax'
                ],
                Role\Tutor::class => [
